...
If nothing was returned, please contact Stache.
    ...
    def authcrusher(database_path):
        ...
        check_query_bridgepay = "SELECT ZDATECREATED FROM ZPAYMENT WHERE ZBATCHSEQUENCENUMBER4 IS NOT NULL"
        check_query_mercury = "SELECT ZDATECREATED FROM ZPAYMENT WHERE ZBATCHSEQUENCENUMBER2 IS NOT NULL"
